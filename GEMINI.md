...
This is a Next.js project named "advonex". It's a PWA, a platform for lawyers and clients.
...
- always create a <taskname>-plan.md file in instructions folder for each task, and only proceed with implementations after the user's approval.
...
- You should and can use existing code but, DO NOT modify existing codebase without permission or explicit command to do so.
