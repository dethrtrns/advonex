    ...
    const fetchLawyerProfile = async () => {
      ...
      try {
        const lawyerProfileId =
          activeAppSide === "LAWYER" && user?.profileIds.lawyerId
            ? user?.profileIds.lawyerId
            : lawyerId;
        ...
        setError(
          "Could not load lawyer profile. Please try a different lawyer."
        );
      } finally {
        setIsLoading(false);
      }
            ...
            {lawyer.photo ? (
              <img
                ...
                onError={(e) => {
                  ...
                  document
                    .getElementById(`initials-${lawyerId}`)
            ...
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span>
                {lawyer.location?.city?.name ? (
                  <div>
                    {lawyer.location?.city.name},{"     "}
                    {lawyer.location?.city.state?.name}{" "}
                  </div>
                ) : (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {lawyer.primaryCourt?.name || "Not provided"}
                  </div>
                </div>
              </div>
              {lawyer.practiceCourts && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      {lawyer.practiceCourts
                        ?.map((court) => court.practiceCourt.name)
                        .join(", ")}
                    </div>
                  </div>
                </div>
